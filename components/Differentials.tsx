            ...
            {differentials.map((item, index) => {
              ...
              return (
                <ScrollReveal key={index} direction="zoom" delay={index * 100}>
                  <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] border border-cream-200 group h-full">
                    <div className="w-14 h-14 bg-accent/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-accent transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
                      <Icon className="w-7 h-7 text-accent group-hover:text-white transition-colors duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]" />
                    </div>
