        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 group hover:-translate-y-2 border border-cream-200"
              >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-accent font-medium hover:text-accent-600 transition-colors group/link"
                >
                  Saiba mais
