          ...
          <ScrollReveal direction="left">
            <div className="relative">
              <div className="relative aspect-[3/4] max-h-[700px] rounded-3xl overflow-hidden shadow-2xl group">
                ...
                <button
                  onClick={toggleVideo}
                  className="absolute inset-0 flex items-center justify-center bg-primary/30 group-hover:bg-primary/40 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]"
                  aria-label={isPlaying ? 'Pausar vídeo' : 'Reproduzir vídeo'}
                >
                  <div className="w-20 h-20 bg-white/90 rounded-full flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
                    {isPlaying ? (
