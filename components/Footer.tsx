    ...
    <footer className="bg-primary text-cream">
      ...
      <div className="section-padding border-b border-primary-700">
        <div className="container-custom mx-auto text-center">
          <TaglineReveal
            words={['Cada', 'cabelo', 'merece', 'o', 'melhor', 'cuidado', 'de', 'Alcântara.']}
            className="font-serif text-3xl md:text-4xl lg:text-6xl font-bold text-cream mb-8"
          />
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-cream/10 rounded-full flex items-center justify-center hover:bg-accent transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]"
                ...
                <ul className="space-y-3">
                  <li>
                    <button
                      ...
                      className="text-cream-300 hover:text-accent transition-colors duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]"
                    >
                      Início
                    </button>
                  </li>
            ...
            <div className="mt-12 pt-8 border-t border-primary-700 flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <p className="text-cream-400 text-sm">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-accent hover:text-accent-300 transition-colors duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] underline"
                >
