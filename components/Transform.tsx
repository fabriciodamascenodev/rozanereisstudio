              ...
              <div className="text-cream order-2 lg:order-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="border-2 border-cream/30 text-cream px-8 py-4 rounded-full font-medium transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-cream/10 flex items-center justify-center gap-2"
                  >
